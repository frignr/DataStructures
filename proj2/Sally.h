...
private:
   ...
   static void doDup(Sally *Ptr);
   static void doDrop(Sally *Ptr);
   static void doSwap(Sally *Ptr);
   static void doRot(Sally *Ptr);

   static void doSet(Sally *Ptr);
   static void doAt(Sally *Ptr);
   static void doStore(Sally *Ptr);

   static void less(Sally *Ptr);
   static void lessOrEqual(Sally *Ptr);
   static void equal(Sally *Ptr);
   static void notEqual(Sally *Ptr);
   static void greaterOrEqual(Sally *Ptr);
   static void greater(Sally *Ptr);

   static void doAnd(Sally *Ptr);
   static void doOr(Sally *Ptr);
   static void doNot(Sally *Ptr);
   
   static void doIfThen(Sally *Ptr);
   static void doElse(Sally *Ptr);
   static void doEndIf(Sally *Ptr);
   static void doDo(Sally *Ptr);
   static void doUntil(Sally *Ptr);
} ;
